## Using the state of Missori, USA public employee dataset sourced from Kaggle. it is a relatively small dataset cotaining records for salaries paid to state employees for year 2024. 
## I came up with the following analytical questions:
